...
<GitHubCode
	...
	commit="ac8296791397d2f629e19f8687f8ffad55be8089"
	lang="ts"
...
This API is in beta. See the multipart/form-data Workers Script Upload API below.
:::

### multipart/form-data upload API

This API uses [multipart/form-data](https://developer.mozilla.org/en-US/docs/Web/HTTP/Reference/Methods/POST) to upload a Worker and will implicitly create a version and deployment.

:::note

The above API is recommended for transparent management of versions and deployments.
:::
